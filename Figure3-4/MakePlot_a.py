...
indices_of_true_ranks_1 = np.loadtxt('alg1rank_AC_G_MC=1000_ss=1000.csv')
indices_of_true_ranks_2 = np.loadtxt('alg2rank_AC_G_MC=1000_ss=1000.csv')


overflow_count = np.loadtxt('overflow_probability_count_G.csv')
...
tikzplotlib.save("G1_AC_ss=1000_mc=1000_Feb18.tex")
...
tikzplotlib.save("G2_AC_ss=1000_mc=1000_Feb18.tex")
