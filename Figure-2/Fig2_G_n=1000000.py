...
#    counter2 += 1
#
#np.savetxt('alg1rank_G_MC=1000_ss=1000000.csv', indices_of_true_ranks_1.astype(int))
#np.savetxt('alg2rank_G_MC=1000_ss=1000000.csv',indices_of_true_ranks_2.astype(int))
#np.savetxt('alg3rank_G_MC=1000_ss=1000000.csv', indices_of_true_ranks_3.astype(int))
#np.savetxt('alg4rank_G_MC=1000_ss=1000000.csv', indices_of_true_ranks_4.astype(int))



indices_of_true_ranks_1 = np.loadtxt('alg1rank_G_MC=1000_ss=1000000.csv')
indices_of_true_ranks_2 = np.loadtxt('alg2rank_G_MC=1000_ss=1000000.csv')
indices_of_true_ranks_3 = np.loadtxt('alg3rank_G_MC=1000_ss=1000000.csv')
indices_of_true_ranks_4 = np.loadtxt('alg4rank_G_MC=1000_ss=1000000.csv')
...
#tikzplotlib.save("G1_ss=1000000_mc=1000_Feb12.tex")
...
#tikzplotlib.save("G2_ss=1000000_mc=1000_Feb12.tex")
...
#tikzplotlib.save("G3_ss=1000000_mc=1000_Feb12.tex")
...
#tikzplotlib.save("G4_ss=1000000_mc=1000_Feb12.tex")
