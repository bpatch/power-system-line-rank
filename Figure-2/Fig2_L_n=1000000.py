...
#### ALGORITHM 2
    ...
    for checks in range(k1):
        indices_of_true_ranks_2[sample,checks] = np.where(sorted_lines2==laplace_true[:k1][checks])[0][0]+1
...
#### ALGORITHM 3
    ...
    for checks in range(k1):
        indices_of_true_ranks_3[sample,checks] = np.where(sorted_lines3==laplace_true[:k1][checks])[0][0]+1
...
#### ALGORITHM 4
    ...
    for checks in range(k1):
        indices_of_true_ranks_4[sample,checks] = np.where(sorted_lines4==laplace_true[:k1][checks])[0][0]+1
...
#### ALGORITHM 1
    ...
    for checks in range(k1):
        indices_of_true_ranks_1[sample,checks] = np.where(sorted_lines1==laplace_true[:k1][checks])[0][0]+1
...
np.savetxt('alg1rank_L_MC=1000_ss=1000000.csv', indices_of_true_ranks_1.astype(int))
np.savetxt('alg2rank_L_MC=1000_ss=1000000.csv',indices_of_true_ranks_2.astype(int))
np.savetxt('alg3rank_L_MC=1000_ss=1000000.csv', indices_of_true_ranks_3.astype(int))
np.savetxt('alg4rank_L_MC=1000_ss=1000000.csv', indices_of_true_ranks_4.astype(int))


#indices_of_true_ranks_1 = np.loadtxt('alg1rank_L_MC=1000_ss=1000000.csv')
#indices_of_true_ranks_2 = np.loadtxt('alg2rank_L_MC=1000_ss=1000000.csv')
#indices_of_true_ranks_3 = np.loadtxt('alg3rank_L_MC=1000_ss=1000000.csv')
#indices_of_true_ranks_4 = np.loadtxt('alg4rank_L_MC=1000_ss=1000000.csv')
...
for checks in range(k1):
    ...
    mean_1[0,checks] = np.median(indices_of_true_ranks_1[:,checks])
    ...
    mean_2[0,checks] = np.median(indices_of_true_ranks_2[:,checks])
    ...
    mean_3[0,checks] = np.median(indices_of_true_ranks_3[:,checks])
    ...
    mean_4[0,checks] = np.median(indices_of_true_ranks_4[:,checks])
...
tikzplotlib.save("L1_ss=1000000_mc=1000_Feb7.tex")
...
tikzplotlib.save("L2_ss=1000000_mc=1000_Feb7.tex")
...
tikzplotlib.save("L3_ss=1000000_mc=1000_Feb7.tex")
...
tikzplotlib.save("L4_ss=1000000_mc=1000_Feb7.tex")
