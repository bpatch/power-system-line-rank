...
#plt.plot(range(len(np.mean(alg3_data_k1 <= 1, axis=0))),1-np.mean(alg3_data_k1 <= 1, axis=0), 'r-')
np.savetxt('alg3data_k1_L_MC=1000_P=10.csv',alg3_data_k1.astype(int))
np.savetxt('alg3data_k2_L_MC=1000_P=10.csv',alg3_data_k2.astype(int))
#np.savetxt('alg3data_k3_L_MC=1000_P=10.csv',alg3_data_k3.astype(int))
#np.savetxt('alg3data_k4_L_MC=1000_P=10.csv',alg3_data_k4.astype(int))
#np.savetxt('alg3data_k5_L_MC=1000_P=10.csv',alg3_data_k5.astype(int))
