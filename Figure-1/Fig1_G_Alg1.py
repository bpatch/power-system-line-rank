...
np.savetxt('alg1data_k1_G_MC=1000.csv',alg1_data_k1.astype(int))
np.savetxt('alg1data_k2_G_MC=1000.csv',alg1_data_k2.astype(int))
#np.savetxt('alg1data_k3_G_MC=1000.csv',alg1_data_k3.astype(int))
#np.savetxt('alg1data_k4_G_MC=1000.csv',alg1_data_k4.astype(int))
#np.savetxt('alg1data_k5_G_MC=1000.csv',alg1_data_k5.astype(int))
